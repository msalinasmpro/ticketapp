        ...
        <div className="rounded-2xl bg-surface border border-border p-8 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button
              ...
              className="flex items-center gap-4 rounded-xl border border-border bg-surface p-5 text-left hover:bg-surface-hover hover:border-light transition-all duration-200 group"
            >
              <div className="h-12 w-12 rounded-xl bg-background flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
