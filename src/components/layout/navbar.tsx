      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex h-9 items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            {session && (
              <>
                <button onClick={toggle} className="h-7 w-7 rounded-[4px] flex items-center justify-center text-muted hover:text-foreground hover:bg-surface-hover transition-colors duration-[120ms]" title={theme === 'dark' ? 'Modo claro' : 'Modo oscuro'}>
                  {theme === 'dark' ? (
                    <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="relative" ref={menuRef}>
                  <button onClick={() => setMenuOpen(!menuOpen)} className="flex items-center gap-2 rounded-[4px] px-2 py-1 text-[13px] text-muted hover:bg-surface-hover transition-colors duration-[120ms]">
                  ...
                  {menuOpen && (
                    <div className="absolute right-0 mt-2 w-52 rounded-[4px] bg-surface border border-border py-1 shadow-xl shadow-black/30">
                      ...
                      <Link
                        ...
                        className="w-full text-left px-3 py-2 text-[13px] text-muted hover:text-foreground hover:bg-surface-hover flex items-center gap-2 transition-colors duration-[120ms]"
                      >
                      ...
                      <button onClick={() => signOut({ callbackUrl: '/auth/login' })} className="w-full text-left px-3 py-2 text-[13px] text-muted hover:text-red hover:bg-red-light flex items-center gap-2 transition-colors duration-[120ms]">
